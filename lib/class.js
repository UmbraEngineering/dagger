...
// 
// Modified for use in Dagger.js by James Brumond
// 
...
Class.extend = function(prop) {
	...
	// Anything in the static property is placed directly on the model
	var static = prop.static;
	delete prop.static;
	...
	// Extend the model with given statics
	for (var name in static) {
		if (static.hasOwnProperty(name)) {
			Class[name] = static;
		}
	}
