...
//  Dagger specific code for initializing resource instances
	...
	// 
	if (expose) {
		model.resource = modelResource.createDefaultModelResource(name, model, schemaDescription, props.public, readonlyFields, populateFields.join(' '));
	}
