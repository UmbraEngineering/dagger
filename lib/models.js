...
var modelSubResource = require('./model-resources/subresource.js');
...
//  Dagger specific code for initializing resource instances
	...
	if (props.expose) {
		...
		// Build any needed sub-resources
		// subResourceFields.forEach(function(field) {
		// 	exports.require(field).resolve(function(submodel) {
		// 		modelSubResource.create(submodel.name, {
		// 			model: submodel,
		// 			parent: model
		// 		});
		// 	});
